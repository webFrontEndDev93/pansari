...
That produces **`pansari-shop.zip`**, about 270 KB. Node is never bundled: it
...
It puts a **Pansari icon on the desktop** and asks whether to open the till
...
Pansari listens on the whole network, so a phone or tablet on the same Wi-Fi can
...
records. Close and reopen Pansari afterwards.
