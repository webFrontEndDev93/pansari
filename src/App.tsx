...
export default function App() {
  ...
  const [collapsed, setCollapsed] = useState(
    () => localStorage.getItem('pansari.sidebar') === 'collapsed',
  );
  ...
  useEffect(() => {
    localStorage.setItem('pansari.sidebar', collapsed ? 'collapsed' : 'expanded');
  }, [collapsed]);
  ...
  useEffect(() => {
    document.title = `${ROUTE_TITLES[route]} · ${settings.shopName || 'Pansari'}`;
