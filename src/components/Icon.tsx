...
export type IconName =
  ...
  | 'alert' | 'clock' | 'basket' | 'print' | 'sun' | 'moon' | 'wallet' | 'card' | 'qr' | 'cash'
  | 'user' | 'phone' | 'download' | 'upload' | 'box' | 'trendUp' | 'trendDown' | 'receipt'
  | 'sparkles' | 'menu' | 'filter' | 'calendar' | 'scale' | 'shield' | 'refresh' | 'arrowRight';
...
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  basket: <><path d="M4 9h16l-1.8 9.4a2 2 0 0 1-2 1.6H7.8a2 2 0 0 1-2-1.6z" /><path d="M8.5 9 12 3l3.5 6" /><path d="M10 13v3.5M14 13v3.5" /></>,
  ...
  scale: <><path d="M12 4v16M7 20h10" /><path d="M4 8h16" /><path d="M7 8 4 14a3 3 0 0 0 6 0z" /><path d="M17 8l-3 6a3 3 0 0 0 6 0z" /></>,
