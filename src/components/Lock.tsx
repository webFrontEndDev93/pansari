  ...
  return (
    <div className="lock">
      <form className="lock-card" onSubmit={submit}>
        <div className="lock-mark"><Icon name="basket" size={24} strokeWidth={2} /></div>

        <h1 className="lock-title">{setup ? 'Set up the till' : 'Pansari'}</h1>
        ...
        <p className="lock-foot">
          {setup
            ...
            : 'Forgot it? Delete server/data/auth.json on this computer and restart Pansari to set a new one.'}
        </p>
      </form>
    </div>
  );
