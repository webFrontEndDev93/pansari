...
export function SettingsPage() {
  ...
  const downloadBackup = async () => {
    try {
      ...
      link.href = url;
      link.download = `pansari-backup-${new Date().toISOString().slice(0, 10)}.json`;
      link.click();
  ...
  const pickRestoreFile = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = () => {
      try {
        ...
        notify('error', 'That file is not readable', 'Pick a Pansari backup saved from this screen.');
      }
    };
    ...
    <div className="page">
          ...
          <div className="card-body">
            <div className="setting-row" style={{ paddingTop: 0 }}>
              <div>
                ...
                <div className="setting-desc">Runs when Pansari starts, then on the schedule below.</div>
              </div>
              <Switch
              ...
              <div className="span-2">
                ...
                >
                  <input
                    ...
                    placeholder="/media/usb/pansari  or  D:\\pansari-backups"
            ...
            <div style={{ marginTop: 'var(--space-5)' }}>
              ...
              {!backups ? (
                ...
                <p className="muted" style={{ fontSize: 'var(--text-sm)' }}>
                  No backups yet. One is written each time Pansari starts.
                </p>
              ) : (
          ...
          <div className="card-body">
            ...
            <div className="setting-row">
              <div>
                ...
                <div className="setting-desc">
                  Locks the counter without stopping Pansari. You are signed in as{' '}
      ...
      {restoring !== null && (
        <ConfirmDialog
          ...
          message="Everything currently in Pansari — medicines, stock, customers and bills — will be replaced by the contents of this backup file. The current data is copied into server/data/backups first."
